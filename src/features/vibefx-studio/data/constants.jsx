...
/* Meme valeur que la marge exterieure par defaut: une grille doit tomber
   symetrique des le premier rendu (marge du bord = ecart entre les images). */
export const DEFAULT_CUSTOM_LAYOUT_GAP = 24;
