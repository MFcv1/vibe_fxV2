...
export const CAMERA_BRANDS = [
    {
        ...
        profiles: [
            ...
            { name: 'Velvia', desc: 'Paysages, couleurs explosives, noirs profonds', filters: { brightness: 100, contrast: 125, saturation: 145, blur: 0, grain: 15, vignette: 10, temperature: 0, fadedBlacks: 0, toneCurveMaster: [0, 50, 128, 210, 255], toneCurveG: [0, 60, 128, 215, 255], toneCurveR: [0, 50, 128, 210, 255] } },
            ...
            { name: 'Eterna Bleach Bypass', desc: 'Métallique, contrasté, désaturé', filters: { brightness: 105, contrast: 140, saturation: 40, blur: 0, grain: 40, vignette: 25, temperature: -10, fadedBlacks: 0, toneCurveMaster: [0, 40, 128, 220, 255], highlightTint: '#e6f2ff', highlightTintIntensity: 15 } },
            { name: 'Classic Neg.', desc: 'Superia 90s, HL chauds, ombres froides', filters: { brightness: 100, contrast: 120, saturation: 95, blur: 0, grain: 35, vignette: 20, temperature: 0, fadedBlacks: 0, toneCurveMaster: [12, 55, 128, 210, 245], toneCurveG: [0, 60, 128, 190, 255], shadowTint: '#002233', shadowTintIntensity: 25, highlightTint: '#ffddaa', highlightTintIntensity: 20 } },
    ...
    },
    {
        ...
        profiles: [
            ...
            { name: 'Ektar 100', desc: 'Vivid, paysages, contraste+', filters: { brightness: 100, contrast: 135, saturation: 140, blur: 0, grain: 10, vignette: 15, temperature: 0, fadedBlacks: 0, toneCurveR: [0, 60, 128, 205, 255], toneCurveB: [0, 60, 128, 205, 255] } },
            { name: 'Gold 200', desc: 'Classique 90s, doré et chaud', filters: { brightness: 105, contrast: 110, saturation: 125, blur: 0, grain: 35, vignette: 20, temperature: 20, fadedBlacks: 12, highlightTint: '#ffd700', highlightTintIntensity: 15 } },
            { name: 'UltraMax 400', desc: 'Punchy, froids/bleus saturés', filters: { brightness: 100, contrast: 125, saturation: 130, blur: 0, grain: 45, vignette: 15, temperature: -10, fadedBlacks: 0, toneCurveB: [0, 68, 128, 200, 255] } },
    ...
    },
    {
        ...
        profiles: [
            ...
            { name: 'VV2 (Vivid 2)', desc: 'Pop colors intenses', filters: { brightness: 105, contrast: 120, saturation: 125, blur: 0, grain: 5, vignette: 15, temperature: 5, fadedBlacks: 0, toneCurveMaster: [0, 45, 128, 215, 255] } },
    ...
    },
    {
        ...
        profiles: [
            ...
            { name: 'Classic (CLS)', desc: 'Analogique ciné, soft sat, chaud', filters: { brightness: 95, contrast: 130, saturation: 85, blur: 0, grain: 35, vignette: 30, temperature: 10, fadedBlacks: 5, toneCurveMaster: [0, 45, 128, 200, 250], shadowTint: '#1a110a', shadowTintIntensity: 20 } },
            ...
            { name: 'Brass (BRS)', desc: 'Golden hour glow', filters: { brightness: 105, contrast: 110, saturation: 120, blur: 0, grain: 20, vignette: 25, temperature: 25, fadedBlacks: 5, highlightTint: '#ffcc66', highlightTintIntensity: 25 } },
            ...
            { name: 'Teal (TEL)', desc: 'Cyan-blue cinématique nuit', filters: { brightness: 105, contrast: 120, saturation: 90, blur: 0, grain: 30, vignette: 25, temperature: -15, fadedBlacks: 5, shadowTint: '#002b33', shadowTintIntensity: 30, highlightTint: '#ccffff', highlightTintIntensity: 10 } },
            { name: 'Vivid (VIV)', desc: 'Haut contraste et saturation', filters: { brightness: 100, contrast: 125, saturation: 130, blur: 0, grain: 15, vignette: 20, temperature: 0, fadedBlacks: 0, toneCurveMaster: [0, 40, 128, 220, 255] } },
            { name: 'Sepia (SEP)', desc: 'Vintage brun/jaune', filters: { brightness: 95, contrast: 125, saturation: 0, blur: 0, grain: 45, vignette: 35, temperature: 0, fadedBlacks: 15, shadowTint: '#331a00', shadowTintIntensity: 60, highlightTint: '#ffea80', highlightTintIntensity: 40 } },
